...
_addcarry_u32(unsigned char c_in, unsigned int src1, unsigned int src2, unsigned int* sum_out);
#pragma intrinsic(_addcarry_u32)

EXTERN_C unsigned char
_addcarry_u64(unsigned char c_in, unsigned __int64 src1, unsigned __int64 src2, unsigned __int64* sum_out);
#pragma intrinsic(_addcarry_u64)

EXTERN_C unsigned char _BitScanForward(unsigned long* index, unsigned long mask);
#pragma intrinsic(_BitScanForward)

EXTERN_C unsigned char _BitScanForward64(unsigned long* index, unsigned long long mask);
#pragma intrinsic(_BitScanForward64)

EXTERN_C unsigned char _BitScanReverse(unsigned long* index, unsigned long mask);
#pragma intrinsic(_BitScanReverse)

EXTERN_C unsigned char _BitScanReverse64(unsigned long* index, unsigned long long mask);
...
EXTERN_C char _InterlockedCompareExchange8(volatile char* place, char new_value, char expected);
