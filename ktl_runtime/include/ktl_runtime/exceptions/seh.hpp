...
namespace ktl::crt::exceptions::win
{
...
using x86_frame_handler_t = ExceptionDisposition CRTCALL(
    exception_record* exception_record, x86_seh_registration* registration, x86_cpu_context* cpu_context, void* dispatcher_context
);
...
using x64_frame_handler_t = ExceptionDisposition(
    exception_record* exception_record, byte* frame_ptr, x64_cpu_context*, void* dispatcher_context
);
