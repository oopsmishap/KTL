...
{
template <class Request, class ConcreteBuilder> class heap_request_builder_base
{
  public:
    using request_type = Request;

    constexpr heap_request_builder_base(request_type request) : m_request{request}
    {
    }

    constexpr ConcreteBuilder& set_alignment(std::align_val_t alignment) noexcept
    {
...
struct alloc_request_builder : heap::details::heap_request_builder_base<alloc_request, alloc_request_builder>
{
    using MyBase = heap_request_builder_base<alloc_request, alloc_request_builder>;

    constexpr explicit alloc_request_builder(size_t count, crt::pool_type_t pool_type) noexcept
...
struct free_request_builder : heap::details::heap_request_builder_base<free_request, free_request_builder>
{
    using MyBase = heap_request_builder_base<free_request, free_request_builder>;

    constexpr explicit free_request_builder(void* memory_block, size_t bytes_count) noexcept
...
extern template void* allocate_memory<OnAllocationFailure::DoNothing>(alloc_request request) noexcept;

extern template void* allocate_memory<OnAllocationFailure::ThrowException>(alloc_request request);
