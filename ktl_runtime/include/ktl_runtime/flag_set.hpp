...
namespace ktl
{
template <typename Enum> struct flag_set
{
    ...
    constexpr flag_set(Enums... flags) noexcept : m_value{(static_cast<value_type>(flags) | ...)}
    {
    }
    ...
    constexpr Enum as_enum() const noexcept
    {
    ...
    template <Enum... flags> constexpr value_type bit_intersection() const noexcept
    {
        return value() & make_union_mask<flags...>();
    }

    template <Enum... flags> constexpr value_type bit_union() const noexcept
    {
        return value() | make_union_mask<flags...>();
    }
    ...
    template <Enum flag> constexpr value_type get() const noexcept
    {
  ...
  private:
    template <Enum... flags> static constexpr value_type make_union_mask() noexcept
    {
...
template <typename Enum> constexpr auto operator|(flag_set<Enum> lhs, flag_set<Enum> rhs) noexcept
{
...
template <typename Enum> constexpr bool operator==(flag_set<Enum> lhs, flag_set<Enum> rhs) noexcept
{
