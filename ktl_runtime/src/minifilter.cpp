#include <ktl_runtime/minifilter.hpp>
...
EXTERN_C NTSTATUS STDCALL KtlRegisterFilter(DRIVER_OBJECT* driver_object, const FLT_REGISTRATION& flt_registration) noexcept
{
