...
{
template <typename NativeStrTy, class = void> class native_string_traits;

template <typename NativeStrTy>
class native_string_traits<
    NativeStrTy,
    void_t<
        decltype(declval<NativeStrTy>().Buffer),
        ...
        decltype(declval<NativeStrTy>().MaximumLength)>>
{
  ...
  public:
    ...
    static constexpr const value_type* get_buffer(const NativeStrTy& str) noexcept
    {
        return str.Buffer;
    }

    static constexpr void set_buffer(NativeStrTy& str, value_type* buffer) noexcept
    {
        str.Buffer = buffer;
    }
    ...
    static constexpr void set_size(NativeStrTy& str, size_type ch_count) noexcept
    {
        str.Length = ch_count_to_bytes(ch_count);
    }

    static constexpr void increase_size(NativeStrTy& str, size_type addendum) noexcept
    {
        str.Length += ch_count_to_bytes(addendum);
    }

    static constexpr void decrease_size(NativeStrTy& str, size_type subtrahend) noexcept
    {
    ...
    static constexpr void set_capacity(NativeStrTy& str, size_type new_capacity) noexcept
    {
...
template <typename CharT> struct native_string_traits_selector;

template <> struct native_string_traits_selector<char> : native_string_traits<native_ansi_str_t>
{
};

template <> struct native_string_traits_selector<wchar_t> : native_string_traits<native_unicode_str_t>
{
};
...
template <typename CharT, class Traits = char_traits<CharT>> class basic_winnt_string_view;

template <class Traits> using basic_ansi_string_view = basic_winnt_string_view<char, Traits>;

template <class Traits> using basic_unicode_string_view = basic_winnt_string_view<wchar_t, Traits>;
...
template <
    ...
    class Alloc = basic_paged_allocator<typename str::details::native_string_traits_selector<CharT>::value_type>>
...
template <
    ...
    class Traits = char_traits<CharT>,
    class Alloc = basic_non_paged_allocator<typename str::details::native_string_traits_selector<CharT>::value_type>>
class basic_winnt_string_non_paged;

template <
    size_t SsoBufferChCount,
    class Traits = char_traits<char>,
    class Alloc  = basic_paged_allocator<str::details::native_string_traits_selector<char>::value_type>>
using basic_ansi_string = basic_winnt_string<char, SsoBufferChCount, Traits, Alloc>;

template <
    size_t SsoBufferChCount,
    class Traits = char_traits<wchar_t>,
    class Alloc  = basic_paged_allocator<str::details::native_string_traits_selector<wchar_t>::value_type>>
using basic_unicode_string = basic_winnt_string<wchar_t, SsoBufferChCount, Traits, Alloc>;
...
using ansi_string_non_paged = basic_ansi_string<
    ...
    char_traits<char>,
    basic_non_paged_allocator<str::details::native_string_traits_selector<char>::value_type>>;

using unicode_string = basic_unicode_string<str::details::DEFAULT_SSO_CH_BUFFER_COUNT>;

using unicode_string_non_paged = basic_unicode_string<
    str::details::DEFAULT_SSO_CH_BUFFER_COUNT,
    char_traits<wchar_t>,
    basic_non_paged_allocator<str::details::native_string_traits_selector<wchar_t>::value_type>>;
